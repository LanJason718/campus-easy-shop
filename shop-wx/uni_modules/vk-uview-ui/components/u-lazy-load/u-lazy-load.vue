...
export default {
  ...
  props: {
    ...
    loadingImg: {
      type: String,
      default:
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAABWZkRUNSJJPjAOWrYpkAAABnSURBVHgB5cRjtCVn2oDh+3mravPY57RtxLYzM0kGydi2bdu2EYxi22bbPH2szap6n2/Vj7PWXr06mWimZ773x3VRKpX0yTAAT4YBeDIMwJNhAJ4MA/BkGIAnwwA8GQbgyTAAT8b/AUT9JvvDMImtAAAAAElFTkSuQmCC'
    },
    // 加载失败的错误占位图
    errorImg: {
      type: String,
